...
class Generator:
    ...
    def generate_datasets(self, door_path, handle_path, door_data, handle_data, mesh):
        ...
        handle_length_random = np.random.uniform(self.args.handle_length - 0.02, self.args.handle_length + 0.02)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--handle_path', type=str, default='./assets/lever_door_handle', help='Path to the handle dae file')
    parser.add_argument('--save_path', type=str, default='./generated_datasets/lever_door_datasets', help='Path to the urdf file')
    parser.add_argument('--handle_length', type=float, default=0.15, help='Path to the urdf file')
    parser.add_argument('--door_height', type=float, default=1.8, help='Path to the urdf file')
    parser.add_argument('--lever_door_list', nargs='+', required=True, help="lever_door body parts list")
    parser.add_argument('--lever_door_handle_list', nargs='+', required=True, help="lever_door handle parts list")

    args = parser.parse_args()

    generator = Generator(args)
    
    for door in args.lever_door_list:
        # 拿到bounding box
        ...
        for handle in args.lever_door_handle_list:
